...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'nidhi@gmail.com' ")
...
def employee_details():
    mess._show(title='Employee Details', message="Please open for edit/delete record: 'StudentDetails/StudentDetails.xml' ")
...
window.title("Advance Facial Recognition Employee Attendance System")
...
message3 = tk.Label(window, text="Advance Facial Recognition Employee Attendance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
style.configure("Treeview", background="black", 
                fieldbackground="white", foreground="blue")
...
trackImg = tk.Button(frame1, text="Check All Attendance", command=TrackImages  ,fg="black"  ,bg="#1AFD03"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
